                            ...
                            <div class="card-header">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-3 justify-content-end d-flex">
                                        <a data-size="lg" data-bs-toggle="modal" data-url="<?php echo e(route('custom_page.create')); ?>" data-bs-target="#exampleModal" data-bs-toggle="tooltip" data-bs-whatever="<?php echo e(__('Create Page')); ?>"  class="btn btn-sm btn-primary">
                                                        ...
                                                        <td>
                                                            <span>
                                                                <div class="action-btn bg-primary ms-2">
                                                                        ...
                                                                        data-bs-toggle="modal" data-bs-target="#exampleModal" data-url="<?php echo e(route('custom_page.edit',$key)); ?>"  data-bs-whatever="<?php echo e(__('Edit Page')); ?>" data-size="lg" data-bs-toggle="tooltip"  title="<?php echo e(__('Edit')); ?>" data-original-title="<?php echo e(__('Edit')); ?>">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/vps-m2-srv45.nl/anajob.webmojo.online/Modules/LandingPage/Resources/views/landingpage/menubar/index.blade.php ENDPATH**/ ?>