                            ...
                            <div class="card-header">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-3 justify-content-end d-flex">
                                        <a data-size="lg" data-url="<?php echo e(route('screenshots_create')); ?>" data-bs-toggle="modal"
                                        data-bs-target="#exampleModal" data-bs-toggle="tooltip" data-bs-whatever="<?php echo e(__('Create')); ?>"  class="btn btn-sm btn-primary">
                                                        ...
                                                        <td>
                                                            <span>
                                                                <div class="action-btn bg-primary ms-2">
                                                                        <a href="#" class="mx-3 btn btn-sm align-items-center" data-url="<?php echo e(route('screenshots_edit',$key)); ?>" data-bs-toggle="modal"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/vps-m2-srv45.nl/anajob.webmojo.online/Modules/LandingPage/Resources/views/landingpage/screenshots/index.blade.php ENDPATH**/ ?>