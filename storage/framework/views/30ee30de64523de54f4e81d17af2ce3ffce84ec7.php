...
<head>
    ...
    <meta name="title" content="<?php echo e(isset($setting['meta_keywords']) ? $setting['meta_keywords'] : config('app.name', 'CMMSGo SaaS')); ?>">
    <meta name="description" content="<?php echo e(isset($setting['meta_description']) ? $setting['meta_description'] : 'With Meta Tags you can edit and experiment with your content then preview how your webpage will look on Google, Facebook, Twitter and more!'); ?>">

    <!-- Open Graph / Facebook -->
    <meta property="og:type" content="website">
    <meta property="og:url" content= "<?php echo e(env('APP_URL')); ?>">
    <meta property="og:title" content="<?php echo e(isset($setting['meta_keywords']) ? $setting['meta_keywords'] : config('app.name', 'CMMSGo SaaS')); ?>">
    <meta property="og:description" content="<?php echo e(isset($setting['meta_description']) ? $setting['meta_description'] : 'With Meta Tags you can edit and experiment with your content then preview how your webpage will look on Google, Facebook, Twitter and more!'); ?>">
    <meta property="og:image" content= "<?php echo e($meta_image.(isset($meta_logo) && !empty($meta_logo)?'meta_image.png' :'meta-image.png')); ?>">

    <!-- Twitter -->
    <meta property="twitter:card" content="summary_large_image">
    <meta property="twitter:url" content= "<?php echo e(env('APP_URL')); ?>">
    <meta property="twitter:title" content="<?php echo e(isset($setting['meta_keywords']) ? $setting['meta_keywords'] : config('app.name', 'CMMSGo SaaS')); ?>">
    <meta property="twitter:description" ccontent="<?php echo e(isset($setting['meta_description']) ? $setting['meta_description'] : 'With Meta Tags you can edit and experiment with your content then preview how your webpage will look on Google, Facebook, Twitter and more!'); ?>">
    <meta property="twitter:image" content="<?php echo e($meta_image.(isset($meta_logo) && !empty($meta_logo)?'meta_image.png' :'meta-image.png')); ?>">

    <!-- Favicon icon -->
    <link rel="icon" href="<?php echo e($sup_logo .'/favicon.png?'. time()); ?>" type="image/x-icon" />
...
<?php /**PATH /var/www/vhosts/webmojo7-testserver.nl/webmojo.online/anajob.webmojo.online/Modules/LandingPage/Resources/views/layouts/landingpage.blade.php ENDPATH**/ ?>