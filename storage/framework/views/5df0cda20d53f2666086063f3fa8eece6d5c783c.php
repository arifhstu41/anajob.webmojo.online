                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <?php if(is_array($join_us) || is_object($join_us)): ?>
                                            <?php $__currentLoopData = $join_us; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $joinus): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    <td><?php echo e($joinus->email); ?></td>
                                                    <td>
                                                        <span>
                                                                <div class="action-btn bg-danger ms-2" style="padding-top: 20px;">
                                                                <?php echo Form::open(['method' => 'DELETE', 'route' => ['join_us.destroy', $joinus->id],'id'=>'delete-form-'.$joinus->id]); ?>


                                                                    <a href="#" class="mx-3 btn btn-sm align-items-center bs-pass-para show_confirm " data-bs-toggle="tooltip" title="<?php echo e(__('Delete')); ?>" data-original-title="<?php echo e(__('Delete')); ?>" data-confirm="<?php echo e(__('Are You Sure?').'|'.__('This action can not be undone. Do you want to continue?')); ?>" data-confirm-yes="document.getElementById('delete-form-<?php echo e($joinus->id); ?>').submit();">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/vps-m2-srv45.nl/anajob.webmojo.online/Modules/LandingPage/Resources/views/landingpage/joinus.blade.php ENDPATH**/ ?>