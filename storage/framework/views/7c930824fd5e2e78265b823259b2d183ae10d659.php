...
<?php if(count($all_site)>0): ?> 
<div class="d-flex align-items-center flex-wrap gap-3"> 
    <div class="">
        <select  class="form-select"  id="site-list" onchange="set_site_detail()">
           
            <?php $__currentLoopData = $all_site; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
            <?php  $url='site-standard/'.$val->id.''?>
              <?php if(Request::path() == $url): ?>
              <option value="<?php echo e($val->id); ?>" selected data-site="<?php echo e($val->site_name); ?>"><?php echo e($val->site_name); ?></option> 
              <?php else: ?>
    ...
    <div class="">
       <div class="btn p-0">
          <a class="btn btn-primary" onclick="share_setting('standard')" data-bs-toggle="modal"  data-bs-target="#share_dash_report"><span>
...
<?php $__env->startSection('breadcrumb'); ?>
    ...
    <?php if(count($all_site)>0): ?> 
    <li class="breadcrumb-item" id="current_site" data-siteid="<?php echo e($data->id); ?>"><?php echo e($data->site_name); ?></li>
    <?php endif; ?>
<?php $__env->stopSection(); ?>
    ...
    <div id="share_dash_report" class="modal fade" tabindex="-1" aria-labelledby="exampleModalPopoversLabel" aria-hidden="true" style="display: none;">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <form method="POST" action="<?php echo e(route('save-share-setting','standard')); ?>"  enctype="multipart/form-data"> <?php echo csrf_field(); ?>
...
<script type="text/javascript">
    ...
    <?php $__env->stopPush(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/vps-m2-srv45.nl/anajob.webmojo.online/resources/views/admin/site/site-standard.blade.php ENDPATH**/ ?>