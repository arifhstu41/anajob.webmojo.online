<?php $__env->startSection('page-title'); ?>
    <?php echo e(__('Channel Analytics')); ?>
...
<?php $__env->startSection('breadcrumb'); ?>
    <li class="breadcrumb-item"><a href="<?php echo e(route('dashboard')); ?>"><?php echo e(__('Dashboard')); ?></a></li>
      <li class="breadcrumb-item" aria-current="page"><?php echo e(__('Channel Analytics')); ?></li>
<?php $__env->stopSection(); ?>
                              ...
                              <ul class="nav nav-pills nav-fill row" id="pills-tab" role="tablist">
                                  <li class="nav-item col-sm-1" role="presentation">
                                      <button class="nav-link chanel-analytics active " id="pills-tab-1" onclick="get_channel_data()" data-bs-toggle="pill" data-value
                                          data-bs-target="#" type="button"><?php echo e(('All')); ?></button>
                                  ...
                                  <li class="nav-item col-sm-1" role="presentation">
                                      <button class="nav-link chanel-analytics" id="pills-tab-5" data-value="gaid::-8" onclick="get_channel_data()" data-bs-toggle="pill" data-bs-toggle="pill"
                                          data-bs-target="#" type="button"><?php echo e(('Referrals')); ?></button>
                                  </li>
                                  <li class="nav-item col-sm-1" role="presentation">
                    ...
                    <div class="tab-pane fade show active" id="channel-chart-<?php echo e($j); ?>" role="tabpanel"
                        ...
                        <div class="row">
                          <div class="col-md-6">
                             ...
                             <div class="card">
                                <div class="card-body">
                                  <div id="channel-line-chart-<?php echo e($val); ?>">
                          ...
                          <div class="col-md-6">
                            <div class="card">
                              <div class="card-body">
                                  <div id="channel-bar-chart-<?php echo e($val); ?>">
                                    <div class="loader " id="progress">
                                      <div class="spinner text-center" style="align-items: center;">
                                        <img height="452px"  src="<?php echo e(asset('assets/images/loader.gif')); ?>" />
                                      </div>
          ...
          <ul class="nav nav-pills nav-fill row" id="pills-tab" role="tablist">
            ...
            <?php $__currentLoopData = $metric_option; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <li class="nav-item col-md-3" role="presentation">
                <?php if($i==1): ?>
                <div class="card nav-link card-metrics active" id="<?php echo e($val); ?>" data-bs-toggle="pill"
                      data-bs-target="#channel-chart-<?php echo e($i); ?>"  type="button">
                <?php else: ?>
                <div class="card nav-link card-metrics" id="<?php echo e($val); ?>" data-bs-toggle="pill"
                      data-bs-target="#channel-chart-<?php echo e($i); ?>" data-id="<?php echo e($val); ?>" type="button">
                <?php endif; ?>
                  <div class="card-body px-lg-5">
                    <h4 id="metric_data_<?php echo e($val); ?>">0</h4>
      ...
      <div id="share_channel_report" class="modal fade" tabindex="-1" aria-labelledby="exampleModalPopoversLabel" aria-hidden="true" style="display: none;">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <form method="POST" action="<?php echo e(route('save-share-setting','channel')); ?>"  enctype="multipart/form-data"> <?php echo csrf_field(); ?>
                        <div class="modal-body">
                            <div class="row">
                                <input type="hidden" name="share_site"id="share_site">
                                 <div class="form-group col-md-3">
                                    <label for="name" class="col-form-label"> <?php echo e(__('All')); ?> </label>
                                ...
                                <div class="form-group col-md-3">
                                    <label for="name" class="col-form-label"> <?php echo e(__('Referrals')); ?> </label>
                                    <div class="form-check form-switch">
                                        <input type="checkbox" class="form-check-input input-primary"
                                ...
                                <div class="form-group col-md-3">
                                    <label for="name" class="col-form-label"> <?php echo e(__('Converters')); ?> </label>
                                    <div class="form-check form-switch">
                                        <input type="checkbox" class="form-check-input input-primary"
                                ...
                                <div class="form-group col-md-3">
                                    <label for="name" class="col-form-label"> <?php echo e(__('Other')); ?> </label>
                                    <div class="form-check form-switch">
                                        <input type="checkbox" class="form-check-input input-primary"
                                            name="other" id="other">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/vps-m2-srv45.nl/anajob.webmojo.online/resources/views/admin/analytics/channel.blade.php ENDPATH**/ ?>