                            ...
                            <div class="card-header">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-3 justify-content-end d-flex">
                                        ...
                                        data-bs-target="#exampleModal"  data-bs-toggle="tooltip" data-bs-whatever="{{__('Create')}}"  class="btn btn-sm btn-primary">
                                                        ...
                                                        <td>
                                                            <span>
                                                                <div class="action-btn bg-primary ms-2">
                                                                        <a href="#" class="mx-3 btn btn-sm align-items-center" data-url="{{ route('feature_edit',$key) }}" data-bs-toggle="modal"
                                                ...
                                                @foreach ($other_features as $key => $value)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span>
                                                                <div class="action-btn bg-primary ms-2">
                                                                        <a href="#" class="mx-3 btn btn-sm align-items-center" data-url="{{ route('features_edit',$key) }}" data-bs-toggle="modal"
data-bs-target="#exampleModal" data-title="{{__('Edit Page')}}" data-size="lg" data-bs-whatever="{{__('Edit')}}">
                                                                        <i class="ti ti-pencil text-white" data-bs-toggle="tooltip"  title="{{__('Edit')}}" data-original-title="{{__('Edit')}}"></i>
                                                                    </a>
                                                                </div>
