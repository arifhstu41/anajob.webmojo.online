var arrChartRec = [];
/*add site*/
/*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*/
...
function get_property() {
  ...
  function save_custom_setting(type) {
       ...
       $.ajax({
        ...
        method:"POST",
        data: {"_token": token,'share_site':share_site,'share_met':share_met,'share_metric':share_metric,'share_dim':share_dim,'share_dimension':share_dimension,'is_password':is_password,'password':password},
          success: function(data) {
  ...
  function get_view() {
        ...
        method:"POST",
        data: {"_token": token,'account_id':account_id,'property_id':property_id},
          success: function(data) {
...
function save_widget(type) {
    ...
    $.ajax({
            ...
            method:"POST",
            data: {"_token": token,'id':id,'title':title,'site_id':site_id,'metric_1':metric_1,'metric_2':metric_2},
            success: function(data) {
               if(type=="1")
                {//add 
...
function widget_data(wid_id,type) {
    ...
    $.ajax({
        ...
        method:"POST",
        data: {"_token": token,'site_id':site_id,'wid_id':wid_id,'type':type,'date':date},
        success: function(data) {
            if(type=="0")
            {
    ...
    function area_chart(label,datasets,type,color,title) {
     ...
     function get_live_user(siteid) {
       ...
       $.ajax({
         ...
         method:"POST",
         data: {"_token": token,"siteid":siteid},
         success: function(data) {
...
/*quick view*/
  function qick_view_data(siteName, siteid) {
    ...
    $.ajax({
            ...
            method:"POST",
            data: {"_token": token,"siteName":siteName,"siteid":siteid},
            success: function(data) {
              ...
              if(data.data.is_success==1)
              {
               ...
               if(data.chart.is_success==1)
                {
                  var site_id= data.data.data.site.id;
                  var graph_type= data.data.data.site.graph_type;
                  var graph_color= data.data.data.site.graph_color;
                  var labels= data.chart.data.labels;
                  var datasets= data.chart.data.datasets;
                   quick_chart(graph_type,graph_color,labels,datasets,site_id);
                }
  ...
  function quick_chart(graph_type,graph_color,labels,datasets,site_id) {
         ...
         if (typeof(site_id) !== "undefined" && site_id != null)
        {
          ...
          else
          {
            ...
            $.ajax({
                    ...
                    method:"POST",
                    data: {"_token": token,"site_id":site_id,"metric":metric,"dimension":dimension,"chart_duration":date_duration},
                    success: function(data) {
  ...
  function get_channel_data() {
    ...
    var token= $('meta[name="csrf-token"]').attr('content');
      ...
      $.ajax({
        ...
        method:"POST",
        data: {"_token": token,'segment':segment,"activeMetrics": activeMetrics,'site':site,"actionType":actionType,"date":date},
          success: function(data) {
            if(data.is_success==1)
            {
                if($(".link").length>0)
  ...
  function get_audience_data() {
    ...
    var token= $('meta[name="csrf-token"]').attr('content');
      ...
      $.ajax({
        ...
        method:"POST",
        data: {"_token": token,'dimension':dimension,"activeCard": activeCard,'site':site,"actionType":actionType,"date":date},
          success: function(data) {
            if(data.is_success==1)
            {
...
function quick_link_password_status() {
    ...
    function get_custom_share_chart() {
        ...
        $.ajax({
            ...
            method:"POST",
            data: {"_token": token,'id':id,'chart_duration':date},
            success: function(data) {
