...
<div class="d-flex align-items-center flex-wrap gap-3">
    ...
    <div class="">
      ...
      ><span><i class="ti ti-plus" data-bs-toggle="tooltip" data-bs-original-title={{__('Create Alert')}}></i></span></button>
    </div>
</div>
@endsection
@section('content')
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalPopoversLabel">{{__('Add Aletr')}}</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form method="POST" action="{{ route('save-aletr') }}"  enctype="multipart/form-data"> @csrf
                <div class="modal-body">
                    <div class="row">
                        <div class="form-group col-md-12">
                            <label for="title" class="col-form-label">{{ __('Aletr Title') }}</label>
                            <div class="form-icon-user">
                                <input class="form-control" type="text"  id="title"name="title" placeholder="{{ __('Aletr Title') }}">
                            </div>
                        </div>
