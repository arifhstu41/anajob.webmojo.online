...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">{{__('Aletr History')}}</li>
@endsection
    ...
    <div class="card price-card price-1 wow animate__fadeInUp">
        <div class="card-header border-0 pb-0">
            <div class="d-flex  align-items-center">
                ...
                <div class="gap-4">
                     <h5 class="mb-0 "><a class="text-dark" href="https://demo.rajodiya.com/erpgo-saas/projects/7">{{$val->site->site_name}}</a></h5>
                </div>
