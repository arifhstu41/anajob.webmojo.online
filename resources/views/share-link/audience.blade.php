                              ...
                              <ul class="nav nav-pills nav-fill row" id="pills-tab" role="tablist">
                                  ...
                                  <li class="nav-item col-sm-1" role="presentation">
                                      <button class="nav-link audience-analytics active " id="pills-tab-1" onclick="get_audience_data()" data-bs-toggle="pill" data-value="ga:country"
                                          data-bs-target="#" type="button">{{('Region')}}</button>
                    ...
                    <div class="tab-pane fade show active" id="channel-chart-{{$j}}" role="tabpanel"
                        ...
                        <div class="row">
                          <div class="col-md-6">
                             ...
                             <div class="card">
                                <div class="card-body">
                                  <div id="audience-line-chart-{{$val}}">
          ...
          <ul class="nav nav-pills nav-fill row" id="pills-tab" role="tablist">
            ...
            @foreach($metric_option as $val)
              <li class="nav-item col-md-3" role="presentation">
                @if($i==1)
                <div class="card nav-link audience-card-metrics active" id="{{$val}}" data-bs-toggle="pill"
                      data-bs-target="#channel-chart-{{$i}}"  type="button">
                @else
                <div class="card nav-link audience-card-metrics" id="{{$val}}" data-bs-toggle="pill"
                      data-bs-target="#channel-chart-{{$i}}" data-id="{{$val}}" type="button">
                @endif
                  <div class="card-body px-lg-5">
                    <h4 id="audinece_metric_data_{{$val}}">0</h4>
                    <h5>{{$val}}</h5>
                  </div>
                </div>
