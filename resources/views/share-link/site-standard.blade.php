...
@foreach($languages as $language)
    <a class="dropdown-item @if($language == $currantLang) text-danger @endif" href="{{route('site.dashboard.link',[\Illuminate\Support\Facades\Crypt::encrypt($data->id),$language])}}">{{\Str::upper($language)}}</a>
@endforeach
@endsection
