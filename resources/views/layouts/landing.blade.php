<?php
    ...
    $landing_path=\App\Models\Utility::get_file('landing/');
    $landing=url('/').$landing_path;
...
<head>
    ...
    <!-- Favicon icon -->
    {{-- <link rel="icon"
        href="{{ $logos . '/' . (isset($company_favicon['company_favicon']) && !empty($company_favicon['company_favicon']) ? $company_favicon['company_favicon'] : 'favicon.png') }}"type="image/x-icon" /> --}}
    ...
    <nav class="navbar navbar-expand-md navbar-dark default top-nav-collapse">
        <div class="container">
            <a class="navbar-brand bg-transparent" href="#">
                ...
                <img alt="{{ env('header_text') }}" src="{{ $logo . '/' . (isset($light_logo['company_dark_logo']) && !empty($light_logo['company_light_logo']) ? $light_logo['company_light_logo']. '?'.time() : 'logo-light.png') . '?'.time()}}">
            ...
            <div class="row align-items-center justify-content-between">
                <div class="col-sm-5">
                    ...
                    <div class="my-4 wow animate__fadeInLeft" data-wow-delay="0.8s">
                        <a href="https://demo.rajodiya.com/analyticsgo/login" class="btn btn-light me-2"><i
    ...
    <section class="">
        <div class="container">
            <div class="row align-items-center justify-content-end mb-5">
                ...
                <div class="col-sm-6">
                    <img src="{{ $landing .'img-crm-dash-3.svg'}}"
                        alt="Datta Able Admin Template" class="img-fluid header-img wow animate__fadeInRight"
                        data-wow-delay="0.2s" />
                </div>
            </div>
